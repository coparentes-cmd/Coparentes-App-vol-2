...
class SettingsScreen extends StatelessWidget {
  ...
  void _showEditProfile(
    ...
    showModalBottomSheet(
      ...
      builder: (_) => _EditProfileSheet(user: user, color: color),
    );
  }
  ...
  void _showChangePasswordSheet(BuildContext context, Color color) {
    showModalBottomSheet(
      ...
      builder: (_) => _ChangePasswordSheet(color: color),
    );
  }
  ...
  void _showEmailInviteSheet(BuildContext context, Color color) {
    showModalBottomSheet(
      ...
      builder: (_) => _EmailInviteSheet(color: color),
    );
  }
...
class _EditProfileSheet extends StatefulWidget {
  ...
  const _EditProfileSheet({required this.user, required this.color});
...
class _ChangePasswordSheet extends StatefulWidget {
  ...
  const _ChangePasswordSheet({required this.color});
...
class _EmailInviteSheet extends StatefulWidget {
  ...
  const _EmailInviteSheet({required this.color});
